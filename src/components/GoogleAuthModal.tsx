          ...
          >
            ...
            <div className="px-6 pt-6 pb-4 border-b border-zinc-100 dark:border-zinc-800 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 shadow-xs flex items-center justify-center">
                ...
                <div>
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="inline-flex items-center gap-0.5 px-1.5 py-0.2 rounded text-[9px] font-semibold bg-amber-50 dark:bg-amber-950/60 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800/60">
            ...
            <div className="p-6 space-y-4">
              {currentUser.isGoogleLinked ? (
                <div className="space-y-4">
                  ...
                  <div className="p-4 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200/80 dark:border-emerald-800/60 space-y-3">
                    <div className="flex items-center gap-3">
                      {currentUser.photoUrl ? (
                        <img
                          src={currentUser.photoUrl}
                          alt="Google Profile"
                          className="w-10 h-10 rounded-full border border-emerald-300 dark:border-emerald-600 object-cover"
                        />
                      ) : (
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="text-[11px] text-emerald-800 dark:text-emerald-300 font-mono truncate">
                          {currentUser.googleEmail || currentUser.email}
                        </div>
                      </div>
                    </div>

                    <div className="pt-2 border-t border-emerald-200/60 dark:border-emerald-800/40 flex items-center justify-between text-[10px] text-emerald-800 dark:text-emerald-300">
                      <span>Proyek: <strong>enhanced-catwalk-wtgzl</strong></span>
                      <span className="font-semibold text-emerald-700 dark:text-emerald-400">Firebase Active</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-end gap-2 pt-2">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 border border-rose-200 dark:border-rose-800/60 transition-all tactile-btn"
                    >
                    ...
                    <button
                      onClick={onClose}
                      className="px-4 py-2 rounded-xl text-xs font-semibold bg-zinc-900 hover:bg-zinc-800 dark:bg-emerald-600 dark:hover:bg-emerald-500 text-white transition-all tactile-btn"
                    >
                      Selesai
                    </button>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-750 text-zinc-800 dark:text-zinc-100 text-xs font-semibold shadow-xs hover:shadow-sm transition-all active:scale-[0.99] tactile-btn disabled:opacity-50"
                  >
                  ...
                  {authError && (
                    <div className="p-3 rounded-xl bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800/60 text-amber-900 dark:text-amber-300 text-xs flex items-start gap-2">
                      <AlertCircle className="w-4 h-4 text-amber-600 dark:text-amber-400 shrink-0 mt-0.5" />
                      <div>
                        <span className="font-semibold block">Catatan Otentikasi</span>
                        <span className="text-[11px] text-amber-800 dark:text-amber-300">{authError}</span>
                      </div>
                    </div>
                  )}
