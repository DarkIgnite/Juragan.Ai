...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header
      id="main-header"
      className="sticky top-0 z-40 w-full backdrop-blur-md bg-white/95 border-b border-zinc-200/80 transition-all shadow-2xs"
    >
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-14 sm:h-16 flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-zinc-500 font-medium truncate max-w-[120px] sm:max-w-[160px]">
            ...
            {isAdmin ? (
              <>
                <button
                  ...
                  className={`flex flex-col items-center justify-center h-12 px-5 rounded-xl text-xs font-semibold transition-all relative ${
              ...
              <>
                <button
                  ...
                  className={`flex flex-col items-center justify-center h-12 px-4.5 rounded-xl text-xs font-semibold transition-all relative ${
                    activeTab === 'dashboard'
                      ? 'text-emerald-600'
                      : 'text-zinc-500 hover:text-zinc-900 hover:bg-zinc-100/70'
                  }`}
        ...
        {/* Right Section: Quick Create (+), Voice AI, and Profile Control */}
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          ...
          {(onOpenAddSale || onOpenAddProduct) && (
            <div className="relative" ref={createMenuRef}>
              <button
                ...
                className="w-8.5 h-8.5 sm:w-9 sm:h-9 rounded-full bg-zinc-100 hover:bg-zinc-200 text-zinc-700 flex items-center justify-center transition-all active:scale-95"
              ...
              <AnimatePresence>
                {isCreateMenuOpen && (
                  <motion.div
                    ...
                    className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-lg border border-zinc-200/80 p-2 z-50 space-y-1"
                  >
                    {onOpenAddSale && (
                      <button
                        onClick={() => {
                        ...
                        className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs font-semibold text-zinc-800 hover:bg-emerald-50 hover:text-emerald-800 transition-colors text-left"
                      >
                        ...
                        <div>
                          ...
                          <div className="text-[10px] text-zinc-500 font-normal">Tambah pesanan pembeli</div>
                        </div>
                      </button>
                    )}
                    ...
                    {onOpenAddProduct && (
                      <button
                        ...
                        className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs font-semibold text-zinc-800 hover:bg-blue-50 hover:text-blue-800 transition-colors text-left"
                      >
                        ...
                        <div>
                          ...
                          <div className="text-[10px] text-zinc-500 font-normal">Input barang ke katalog</div>
                        </div>
                      </button>
                    )}
                  </motion.div>
          ...
          {onOpenVoiceConsultation && (
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-full bg-gradient-to-r from-emerald-500/10 via-teal-500/10 to-blue-500/10 hover:from-emerald-500/20 hover:to-blue-500/20 text-emerald-800 text-xs font-semibold transition-all border border-emerald-300/80 active:scale-95 shadow-2xs"
          ...
          <div className="relative" ref={menuRef}>
            ...
            >
              ...
              {/* Online Green Status Dot (Facebook style) */}
                  ...
                  <div className="p-3 bg-zinc-50 rounded-xl border border-zinc-100">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <span className="inline-block mt-1 px-1.5 py-0.5 rounded text-[9px] font-semibold bg-emerald-50 text-emerald-700 border border-emerald-200">
