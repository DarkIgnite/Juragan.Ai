      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="p-6 space-y-4 text-sm text-zinc-600 dark:text-zinc-300">
              ...
              >
                {apiConnected ? (
                  ...
                  <Cpu className="w-5 h-5 text-amber-600 dark:text-amber-400 shrink-0 mt-0.5" />
                )}
                <div>
              ...
              <div className="space-y-2">
                ...
                <ol className="space-y-2 text-xs text-zinc-600 dark:text-zinc-300 list-decimal pl-4">
                  <li>
            ...
            <div className="px-6 py-3.5 bg-zinc-50 dark:bg-zinc-950/80 border-t border-zinc-100 dark:border-zinc-800 flex justify-end">
              <button
                onClick={onClose}
                className="px-4 py-2 rounded-xl bg-zinc-900 hover:bg-zinc-800 dark:bg-emerald-600 dark:hover:bg-emerald-500 text-white text-xs font-medium transition-colors tactile-btn"
              >
                Mengerti &amp; Lanjutkan
              </button>
            </div>
